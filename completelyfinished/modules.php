            ...
            echo '<tr>';
                ...
                if ($latest_thread_result)
                {
                  if ($latest_thread_result->num_rows != 0)
                  {
                    ...
                    {
                        $user = $ltr_row['creatorID'];
                        $profile_link = 'profile.php?user=' . $user .'';

                    echo '<b><a href="posts.php?thread='.$ltr_row['id'].'">'.$ltr_row['title'].'</a></b> at <b>'.$ltr_row['dateOfCreation'].'</b> by <b><a href='.$profile_link.'>' . $user . '</a></b>';
                    }
                    echo '</td>';
                  }
                  else
